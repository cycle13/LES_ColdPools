...
def main():
    ...
    for it,t0 in enumerate(times):
        ...
        w_[w_ < 0.5] = 0
        w_max[0,:,:] = np.amax(w, axis=2)       # maximum value
        w_max[1,:,:] = np.argmax(w_, axis=2)    # height of maximum value
        del w_
        ...
        plot_contourf_test_yz(s, smin, smax, CP_top[it,:,:], CP_top_grad[it,:,:], kmax, t0)
