...
def main():
    ...
    ic = ic_arr[0]
    jc = jc_arr[0]
    KE, KEd, KE_x = compute_KE(ic, jc, irstar, path, path_fields)
...
def compute_KE(ic,jc,irstar, path_in, path_fields):
    print ''
...
def compute_KE_CP_rim(ic,jc,irstar, path_in, path_fields):
    print ''
