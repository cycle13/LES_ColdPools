...
def plot_minmax_timeseries_domain(rstar, d_range, id_list_s, id_list_d, id_list_t,
    ...
    for d, dstar in enumerate(d_range):
        ...
        axis[0, 0].plot(t_d, np.amax(w_max_d[:, :], axis=1), 'o-', color=colorlist3[2], label='double CP collision')
        ...
        axis[1, 0].plot(t_d, np.amax(th_min_d[:, :], axis=1), 'o-', color=colorlist3[2], label='double CP collision')
