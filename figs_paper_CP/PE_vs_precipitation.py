...
def main():
    ...
    # print('if intensity is '+str(intensity)+'mm/h, then duration is: tau='+str(tau_)+'h')
    # print('if duration is '+str(tau)+'h, then intensity is: I='+str(intensity_)+'mm/h')
    #
    print('')
    print('PE range: ')
