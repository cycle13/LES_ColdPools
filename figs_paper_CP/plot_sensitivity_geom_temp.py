...
def plot_sensitivity_plots_all_v2(dTh_range_A, rstar_range_A, zstar_range_A,
    ...
    # ax2.set_title('max. CP height', fontsize=18)
    # # ax3.set_title('CP volume', fontsize=18)
    # ax3.set_title('max. potential temperature', fontsize=18)
    # ax4.set_title('max. w', fontsize=18)
    ...
    #     max_range[2] = np.maximum(max_range[2], np.amax(CP_height_max))
    #     # max_range[3] = np.maximum(max_range[3], 1e-9 * np.amax(CP_vol))
    #     max_range[3] = np.maximum(max_range[4], np.amax(theta_min_k0))
    #     max_range[4] = np.maximum(max_range[5], np.amax(w_max))
    #     # max_range[5] = np.maximum(max_range[6], np.amax(vort_phi_max))
    #     min_range[1] = np.minimum(min_range[1], np.amin(r_av))
    #     min_range[3] = np.minimum(min_range[4], np.amin(theta_min))
    #     ax1.plot(times, r_av, '-', color=colorlist2[i], label=lbl)
    #     ax2.plot(time_geom, CP_height_max, '-', color=colorlist2[i], label=lbl)
    #     # ax3.plot(time_geom, 1e-9*CP_vol, '-', color=colorlist2[i], label=lbl)
    #     ax3.plot(time_stats, theta_min, '-', color=colorlist2[i], label=lbl)
    #     ax3.plot(time_stats,300*np.ones(shape=time_stats.shape), 'k-', linewidth=1)
    ...
    # axis[0,2].text(0.05, 0.97, 'c)',     transform=axis[0, 2].transAxes, fontsize=ftsize, verticalalignment='top', bbox=textprops)
    # # axis[0,3].text(0.05, 0.97, 'd)',     transform=axis[0, 3].transAxes, fontsize=ftsize, verticalalignment='top', bbox=textprops)
    # axis[0,3].text(0.05, 0.97, 'd)',     transform=axis[0, 4].transAxes, fontsize=ftsize, verticalalignment='top', bbox=textprops)
    ...
    # axis[0,4].text(0.05, 0.97, 'e)',     transform=axis[0, 5].transAxes, fontsize=ftsize, verticalalignment='top', bbox=textprops)
    ...
    # axis[1,1].text(.05, 0.97, 'g)',     transform=axis[1, 1].transAxes, fontsize=ftsize, verticalalignment='top', bbox=textprops)
    # axis[1,2].text(.05, 0.97, 'h)',     transform=axis[1, 2].transAxes, fontsize=ftsize, verticalalignment='top', bbox=textprops)
    # # axis[1,3].text(.05, 0.97, 'i)',     transform=axis[1, 3].transAxes, fontsize=ftsize, verticalalignment='top', bbox=textprops)
    # axis[1,3].text(.05, 0.97, 'i)',     transform=axis[1, 4].transAxes, fontsize=ftsize, verticalalignment='top', bbox=textprops)
    ...
    # axis[1,4].text(.05, 0.97, 'k)',     transform=axis[1, 5].transAxes, fontsize=ftsize, verticalalignment='top', bbox=textprops)
    # # axis[1,5].text(.05, 0.97, 'l)',     transform=axis[1, 6].transAxes, fontsize=ftsize, verticalalignment='top', bbox=textprops)
    #
    # print('')
    # for i in range(2):
    #     # ax0.set_ylabel('entropy [J/K]')
