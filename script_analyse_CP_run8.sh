...
path="/nbi/ac/conv3/rawdata/ColdPools_PyCLES/3D_sfc_fluxes_off/single_3D_noise/run8_stable/"
casename="ColdPoolDry_single_3D_stable"
...
#  python plot_streamlines_singleCP.py $casename $fullpath --tmin $tmin --tmax $tmax
...
#  echo "RIM"
#  python updraft_strength.py $casename $fullpath --tmin $tmin --tmax $tmax --path_tracers tracer_k0
